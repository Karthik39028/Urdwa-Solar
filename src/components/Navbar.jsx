...
const links = [
...

  {
    ...
    subItems: [
      ...
      // NEW SECTION
      { href: "/products#products-solar-kits", label: "Solar Kit" },
    ],
  },
...
export function Navbar() {
  ...
  const openProductMenu = () => {
    ...
    productMenuTimer.current = window.setTimeout(() => {
            ...
            >
              ...
              {l.subItems ? (
                <div
                  ...
                  className={`absolute left-0 top-full z-50 mt-3 min-w-[240px] rounded-3xl border border-border/70 bg-white p-3 shadow-soft transition-all duration-200 ${
                    productMenuOpen
                      ? "visible opacity-100"
